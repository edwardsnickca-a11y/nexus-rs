...
const ITEMS = [
  ['mission','Mission'],['current','Current Ops'],['tomorrow',"Tomorrow's Plan"],['sync','Sync Matrix'],['requirements','Requirements'],['platforms','Platforms'],['upad','UPAD Status'],['airspace','Airspace'],['resources','Resource Desk'],['oversight','Intelligence Oversight'],['transition','OP Transition'],['aar','AAR'],['log','Decision Log']
]
