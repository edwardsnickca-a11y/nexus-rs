...
export default function AdvisorPanel({ role }) {
  return <section className="panel advisor"><div className="panel-head"><div><span className="eyebrow">Senior Remote Sensing Mission Advisor</span><h3>Lt Col Edwards</h3></div><span className="live">LIVE</span></div><p>{BRIEFS[role]}</p><textarea placeholder="Enter your decision or update..."/><div className="advisor-actions"><span>Free-text decision record</span><button className="primary small">Submit Decision</button></div></section>
}
