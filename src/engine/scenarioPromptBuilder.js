...
export function buildInitializationContext(state) {
  ...
  return {
    ...
    scenarioConcept:'Northern California Multi-Fire Remote Sensing Operations',
    selectedRole:role,
    ...
    geographicConstraint:'Use 2–5 incidents in real Northern California cities, counties, or recognized operational areas. Do not invent counties, cities, tribal jurisdictions, or geographic features.',
