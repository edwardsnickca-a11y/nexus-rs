    ...
    decisionWindows: [
      {
        ...
        title: 'Clarify Fire Bravo route-access requirement',
        description: 'Fire Bravo request is platform-first and lacks decision, area, timing, and EEIs.',
        openedAtTurn: 1,
        dueByTurn: 3,
        relatedRole: 'collection_manager',
        relatedRequirement: 'req-bravo',
      ...
      },
      {
        ...
        title: 'Close Fire Alpha dissemination loop',
        description: 'The Fire Alpha product is ready to send but customer receipt is not verified.',
        openedAtTurn: 1,
        dueByTurn: 4,
        relatedRole: 'upad_lno',
        relatedRequirement: 'req-alpha',
